...
export const index = () => {
  ...
  return (
    <LoginContainer className="w-full h-full grid grid-cols-12 container md:px-8">
      ...
      <div className="flex flex-col justify-center items-center col-span-12 lg:col-span-7 xl:col-span-5 bg-transparent">
        {!reset ? (
